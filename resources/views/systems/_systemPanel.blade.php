        ...
        <div id="stats" class="grid gird-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="p-6 rounded-lg bg-white shadow-lg hover:bg-indigo-100">
                <div class="flex flex-row space-x-4 items-center">
                    ...
                    <div>
                        <p class="text-sm font-medium uppercase leading-4">Calidad de red móvil (CSQ)</p>
                        <p class="font-bold text-2xl inline-flex items-center space-x-2">
                            <span>{{$systemInfo->GSM_CSQ}}</span>
                        </p>
                    </div>
                    <div>
                        <p class="text-sm font-medium uppercase leading-4">Voltaje en bateria de emergencia</p>
                        <p class="font-bold text-2xl inline-flex items-center space-x-2">
                            <span>{{ number_format($systemInfo->GSM_VOLTAJE, 0, ',', ',') }}V</span>
                        </p>
                    </div>
                </div>
            </div>
            <div class="p-6 rounded-lg @if($systemInfo->GSM_FTP) bg-white @else bg-yellow-200 @endif  shadow-lg hover:bg-indigo-100">
                <div class="flex flex-row space-x-4 items-center">
                    <div id="stats-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
                    ...
                    <div>
                        <p class="text-sm font-medium uppercase leading-4">ENVIO FTP</p>
                        <p class="font-bold text-2xl inline-flex items-center space-x-2">
                            <span> @if($systemInfo->GSM_FTP) Activado @else Desactivado @endif </span>
                        </p>
                    </div>
                </div>
            </div>

            ...
            <div class="flex flex-col items-start p-4">
                ...
                <div class="">
                    ...
                    <div class="grid grid-cols-2 md:space-y-0 items-center space-y-1 p-4 border-b ">
                        ...
                        <p>
                            ID: {{sprintf("%09d", $detailEntry->package_id)}}
                            ...
                            <a class="inline-block text-xs text-blue-500 underline" href="{{ route('history.show', ['package' => $detailEntry->package_id]) }}"> (Ver en paquetes)</a>
                        </p>
                   </div>
